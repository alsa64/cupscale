...
{
    internal class AdvancedModelSelection
    {
        // Models 
        ...
        {
            var saveData = $"name|{name}" + Environment.NewLine
            ...
            var path = Path.Combine(Paths.presetsPath, name);
        ...
        public static bool LoadPreset(string name)
        {
            ...
            var saveDataLines = IOUtils.ReadLines(path);
            foreach (var line in saveDataLines)
            {
                ...
                switch (keyValuePair[0])
                {
                    case "e1m1":
                        ...
                        break;
                    case "e1m1i":
                        e1m1i = keyValuePair[1].GetInt();
                        break;
                    case "e1m2":
                        e1m2 = keyValuePair[1];
                        break;
                    case "e1m2i":
                        e1m2i = keyValuePair[1].GetInt();
                        break;
                    ...
                    case "e2m1":
                        ...
                        break;
                    case "e2m1i":
                        e2m1i = keyValuePair[1].GetInt();
                        break;
                    case "e2m2":
                        e2m2 = keyValuePair[1];
                        break;
                    case "e2m2i":
                        e2m2i = keyValuePair[1].GetInt();
                        break;
                    ...
                    case "e3m1":
                        ...
                        break;
                    case "e3m1i":
                        e3m1i = keyValuePair[1].GetInt();
                        break;
                    case "e3m2":
                        e3m2 = keyValuePair[1];
                        break;
                    case "e3m2i":
                        e3m2i = keyValuePair[1].GetInt();
                        break;
                }
            }
