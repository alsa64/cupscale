...
namespace Cupscale.UI
{
    public static class ExtensionMethods
    {
        ...
        public static string ReplaceInFilename(this string path, string textToFind, string textToReplace,
            bool includeExtension = true)
        {
            ...
            var targetPath = Path.Combine(Path.GetDirectoryName(path), newFilename);
            if (!includeExtension)
                targetPath += ext;
            return targetPath;
        }
        ...
        {
            var parentDir = path.GetParentDir();
